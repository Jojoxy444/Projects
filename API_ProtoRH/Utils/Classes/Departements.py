...
class departement(Base):
    ...
    users = relationship("users", secondary=user_departement, back_populates="departements")

class departement_create(BaseModel):
    name: str

class AddUsersToDepartementRequest(BaseModel):
    user_ids: List[int]

class RemoveToDepartementRequest(BaseModel):
    user_ids: List[int]
