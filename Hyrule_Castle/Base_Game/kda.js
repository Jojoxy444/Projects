...
function display(player, ennemy) {
    ...
    console.log("HP:", "\uD83E\uDD0D".repeat(ennemy.hp) + "\uD83D\uDDA4".repeat(ennemy.max_hp - ennemy.hp), "".concat(ennemy.hp, " / ").concat(ennemy.max_hp));
    console.log("");
    console.log("\u001B[32m".concat(player.name, "\u001B[0m"));
    console.log("HP:", "\uD83E\uDD0D".repeat(player.hp) + "\uD83D\uDDA4".repeat(player.max_hp - player.hp), "".concat(player.hp, " / ").concat(player.max_hp));
    console.log("");
}
